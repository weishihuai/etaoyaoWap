...
<%--页头结束--%>
<div class="container">
    <h5 style="font-weight:bold; padding:10px 0 5px;">订单提交成功，感谢您的订购！</h5>

    <div class="row">
        <div class="col-xs-12">
            <c:choose>
                <c:when test="${orderProxy.payment.payWayId != 1}">
                    <div class="alert alert-danger alert-danger2">
                        请在24小时内完成支付，过时订单将会自动取消
                    </div>
                </c:when>
                <c:otherwise>
                    <div class="alert alert-danger alert-danger2">
    ...
    <div class="row m_rows5">
        ...
        <div class="row">
            <div class="col-xs-12" style="color:#333; font-size:12px; padding-left:10px; margin-top:10px;">商品将发送给<i style="font-weight:bold; font-style:normal;">${orderProxy.receiverName}</i></div>
        </div>
        <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            <button type="button" class="btn btn-default btn-lg btn-block" style="margin:10px 0; font-size:12px; height: 50px;" onclick="window.location.href='${webRoot}/wechat/orderDetail.ac?id=${param.orderId}';">查看订单详情</button>
        </div>
    </div>
</div>
<%--menu开始--%>
