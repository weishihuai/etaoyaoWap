...
<header class="row header">
    <%--<div class="col-xs-2"><a href="${webRoot}/wap/shoppingcart/orderadd.ac?carttype=${carttype}&handler=${handler}&isCod=${isCod?'Y':'N'}"><span class="glyphicon glyphicon-arrow-left"></span></a></div>--%>
...
<div class="row" style=" margin-top: 8px;">
    <div class="col-xs-10 col-xs-offset-1" >
        <button onclick="window.location.href='${webRoot}/wap/module/member/addressOperate.ac?fromPath=addrSelect&carttype=${carttype}&handler=${handler}&isCod=${isCod}&time='+(new Date()).getTime()"
...
<div class="row" style=" margin-top: 8px;">
    <div class="col-xs-10 col-xs-offset-1" >
        <button onclick="window.location.href='${webRoot}/wap/module/member/addressOperate.ac?fromPath=addrSelect&method=edit&carttype=${carttype}&handler=${handler}&receiveAddrId=${selectedAddress.receiveAddrId}&isCod=${isCod}&time='+(new Date()).getTime()"
                class="btn btn-default btn-default_adr btn-block" style="border: 1px solid #CC3333;background: none repeat scroll 0 0 #CC3333; color: #fff; font-weight: bold;" type="button">
            修改收货地址
        </button>
    </div>
