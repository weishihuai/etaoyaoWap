...
<div class="container">
    ...
    <div class="row m_rows2">
        ...
        <div class="col-xs-9"><input   id="zipcode" name="zipcode" type="number" placeholder="请输入邮政编号,可以不填" maxlength="6" class="form-control"></div>
    </div>
    <div class="row m_rows2">
        <div class="col-xs-12">
            <span id="alert" style="padding-left:5px;color:#e00"></span>
            <div class="alert alert-warning sr-only"id="success">请输入搜索关键字!</div>
        </div>
   </div>
    <div class="row m_rows2">
        <div class="col-xs-12">
