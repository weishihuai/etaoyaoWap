...
<head>
    ...
    <script src="${webRoot}/template/bdw/oldWap/statics/js/returnOrder.js" type="text/javascript"></script>
    <script type="text/javascript">
        var webPath = {webRoot:'${webRoot}'};
    </script>
</head>
<%--<c:set value="${bdw:getExchangedPurchaseOrderPage(loginUser.userId,pageNum,8)}" var="exchangeOrderPage"/>--%>
<body>
    ...
    <c:forEach items="${orderProxyPage.result}" var="orderProxy" varStatus="status">
        <ul class="good-list">
            <c:forEach items="${orderProxy.orderItemProxyList}" var="orderItemProxy">
                <c:choose>
                    <c:when test="${orderItemProxy.isCanReturn == true}">
        ...
        <div class="checkout-bar">
            ...
            <a class="goto fr" href="javascript:;" onclick="selectPurchase(${orderId})">填写退货单</a>
