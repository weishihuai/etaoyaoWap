...
Dialog.prototype = {
	...
	createDialogWrap : function( tmpl ){
		// 弹出层标题
        if(tmpl.isShowClose==undefined||tmpl.isShowClose==null||tmpl.isShowClose){
            ...
            var header = tmpl.header ?
                '<h4 class="easyDialog_title" id="easyDialogTitle">' + tmpl.header + '</h4>' :
                '';
        }
			// 确定按钮
		var	yesBtn = typeof tmpl.yesFn === 'function' ?
