/*因为其中有些样式与bootstrap冲突，因此重新从main中复制一套出来*/
(function () {
    ...
    if(!$('.showConfirm').length > 0 ) {
        $('body').append('<div class="msg-box showConfirm" style="display: none" id="confirmId"> ' +
                                ...
                                '<div class="btns celearfix"> ' +
                                     '<a class="itemBtn itemBtn-l fl" onclick="closeConfirm()" href="javascript:;">取消</a>' +
                                     '<a class="itemBtn itemBtn-r fr" id="confirmBt" href="javascript:;">确认</a>            ' +
                                '</div>' +
                            '</div>');
    }
