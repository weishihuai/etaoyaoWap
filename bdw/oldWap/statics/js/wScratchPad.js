...
(function($)
{
    ...
    {
        width			: 280,					// set width - best to match image width
        height			: 80,					// set height - best to match image height
        image			: null,					// set image path
        image2			: null,					// set overlay image path - if set color is not used
        color			: '#777',			    // set scratch color - if image2 is not set uses color
