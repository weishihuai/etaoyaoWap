	...
	$.fn.hScrollPane=function(settings){
		...
		this.each(function(){
			var container=$(this),
				...
				dragbar=(container.find("."+settings.scrollClass).length==0 && c>w ) ? container.append('<div class="'+settings.scrollClass+'"><div class="'+settings.scrollChildClass+'"></div></div>').find("."+settings.scrollClass) : container.find("."+settings.scrollClass),
				handle=dragbar.find("."+settings.scrollChildClass);
