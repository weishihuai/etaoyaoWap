...
(function ($) {
    $(document).ready(function () {
        ...
        $($("#mycarousel a")[0]).addClass("zoomThumbActive");
        $("#mycarousel").hover(function(){},function(){
            $("#mycarousel li").removeClass("cur");
            $("#mycarousel").find("a.zoomThumbActive").parents("li").addClass("cur");
        });
        ...
        this.init = function () {
            ...
            n.bind('mouseenter', this, function (a) {
                ...
                if ($.browser.msie && $.browser.version < 7) {
                    r = $('<iframe frameborder="0" src="#"></iframe>').css({position: "absolute", left: b, top: yPos, zIndex: 99, width: w, height: h}).insertBefore(m)
                }
                m.fadeIn(500);
                if (o) {
                    o.remove();
        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
                ...
                $(this).bind('click', $(this), function (a) {
                    $("#mycarousel").find("a").removeClass("zoomThumbActive");;
