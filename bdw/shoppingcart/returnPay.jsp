...
<c:choose>
            ...
            <div class="box paySuccessBox">
                <ul>
                    ...
                    <li>
                        <p>您的订单已支付成功！</p>
                        <div class="return">
                            <h4>您现在还可以：<a href="${webRoot}/index.ac">返回首页</a>5秒后将自动跳转至<a href="${webRoot}/module/member/index.ac">会员中心</a>页</h4>
                        </div>
    ...
    <c:otherwise>
        <div id="orderSuccess">
            ...
            <div class="box paySuccessBox">
                <ul>
                    <h2><a href="javascript：void(0)"><img src="${webRoot}/template/bdw/statics/images/buyCar_succeIco.gif" /></a></h2>
                    <li>
                        <p>支付成功！</p>
                        <div class="return">
                            <h4>5秒后将后退至提交页</h4>
