...
<head>
	...
	<script type="text/javascript" src="${webRoot}/template/bdw/shop/register/statics/js/registerShopStep03.js"></script>
</head>
		...
		<div class="step03-mc">
			<div class="mc-cont">
				<div class="cb-mt">
					...
					<span>请核实信息并准备相关资质文件进行提交, <a href="${webRoot}/shop/register/registerShopStep02.ac">返回修改</a></span>
				</div>
				...
				<div class="mc-box">
					...
					<div class="box-item">
						...
						<div class="mrt">
							<c:forEach var="customerType" items="${sdk:listAllCustomerType()}">
								<span id="customerType_${customerType.customerTypeId}" style="display: none;">${customerType.customerTypeName}</span>
							</c:forEach>
						</div>
					</div>
					<div class="box-item">
					...
					<div class="box-item">
						<label>是否有实体店:</label>
						<div class="mrt">
							<span id="isOffLineShop"> </span>
						</div>
					</div>
					<div class="box-item">
						<label>仓库发货地址:</label>
						<div class="mrt">
							<span id="shipperAddrAll"> </span><br>
						</div>
					</div>
					<div class="box-item">
