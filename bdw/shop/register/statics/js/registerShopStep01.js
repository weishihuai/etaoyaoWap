...
$(document).ready(function () {
    ...
    var loginId=getByLocalStorage('shopRegisterData.userInf.loginId');
    // var userPsw=getByLocalStorage('shopRegisterData.userInf.userPsw');
    var mobile =getByLocalStorage('shopRegisterData.userInf.userMobile');
    var email = getByLocalStorage('shopRegisterData.userInf.userEmail');
...
var checkShopStep01 = function () {
    ...
    putToLocalStorage('shopRegisterData.userInf.loginId', loginId);
    putToLocalStorage('shopRegisterData.userInf.userPsw', userPswMd5);
    putToLocalStorage('shopRegisterData.userInf.userMobile', mobile);
    putToLocalStorage('shopRegisterData.userInf.userEmail', email);

    location.href = webPath.webRoot+"/shop/register/registerShopStep02.ac"
};
