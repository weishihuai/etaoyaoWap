...
<head>
	...
	<title>开通门店-门店注册-${webName}</title>
	<meta name="keywords" content="${sdk:getSysParamValue('index_keywords')} ${webName},开通门店" />       <%--SEO keywords优化--%>
	...
	<div class="main-bg">
		<div class="main">
			...
			<div class="step04-mc">
				...
				<h5>为了您能尽快成为${webName}的正式入驻门店，请您及时联系${webName}客服进行审核。
					</h5>
				<div class="info">
					...
					<div class="in-mt"><span>快速审核通道,联系微信</span></div>
