...
需要根据客户选择的经营范围、企业类型，控制对应的证件进行显示，默认所有都是隐藏的。
...
<div class="cont-box aptitude">
    ...
    <div class="cb-mc">
        ...
        <div class="item" id="licenseType" style="display: none">
            <label>证件类型</label>
            <div class="mrt">
        ...
        <%--营业执照副本--%>
        <div id="BusinessLicenseCertificate" class="licenseFile" style="display: none">
            <div class="item">
                <label  >营业执照副本<br>
                    及营业执照年检情况</label>
