...
<%
    ...
    try{
        ...
        System.out.println("--------------------------------进入doWeixinConfirmLogin.jsp");
        ...
        stringBuilder.append(reqUrl)
                ...
                .append("&redirect_uri=").append(java.net.URLEncoder.encode(tempContextUrl+"wap/scanCodeLoginVerify.ac?uuid=" + uuid,"GB2312"))
