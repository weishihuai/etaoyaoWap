...
<!--普通购物车-->
<c:set value="${sdk:getUserCartListProxy('store')}" var="normalProxy"/>
<!--药品购物车-->
<c:set value="${sdk:getUserCartListProxy('store_drug')}" var="drugProxy"/>
...
<html>
    <head lang="en">
        ...
        <script type="text/javascript" src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/detail.js"></script>

        <link href="${webRoot}/template/bdw/wap/outlettemplate/default/statics/css/detail.css" type="text/css" rel="stylesheet" />
        ...
        <c:if test="${isWeixin!='Y'}">
            <link href="${webRoot}/template/bdw/wap/outlettemplate/default/statics/css/product-detail-share.css" type="text/css" rel="stylesheet" />
        </c:if>
    </head>
    ...
    <body>
        ...
        <div class="dt-main">
                    ...
                    <c:choose>
                        <c:when test="${empty productProxy.images}">
                            <div class="swiper-slide">
                                <a href=""><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/pic460x460.jpg" alt=""></a>
                            </div>
                        </c:when>
                        <c:otherwise>
            ...
            <div class="goods-part">
                <div class="mt">
                    <div class="pic">
                        <a href="${webRoot}/wap/outlettemplate/default/outletIndex.ac?shopId=${shopInf.shopInfId}">
                            <c:choose>
                                <c:when test="${empty shopInf.images[0]['100X100']}">
                                    <img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/pic70x70.jpg" alt="">
                                </c:when>
                                <c:otherwise>
                    ...
                    <a href="${webRoot}/wap/outlettemplate/default/outletIndex.ac?shopId=${shopInf.shopInfId}" class="name">${shopInf.shopNm}</a>
                </div>
                <div class="mc">
                    <div class="item">
                        <i>${totalProductNum}</i>
                ...
                <div class="md">
                    ...
                    <a href="${webRoot}/wap/outlettemplate/default/outletIndex.ac?shopId=${shopInf.shopInfId}" class="">进店逛逛</a>
                </div>
            </div>
            <div class="dt-tabs">
                <div class="mt">
                                ...
                                <c:when test="${not empty commentProxyResult}">
                                    <c:forEach items="${commentProxyResult}" var="commentProxy" varStatus="s">
                                        <div class="item">
                                            ...
                                            <c:set var="pics" value="${commentProxy.commentPics}"/>
        ...
        <div class="qk-nav">
            ...
            <div class="qk-box nav-block" style="display: none;">
                <a href="${webRoot}/wap/index.ac" class="m-index"><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/shouye.png" alt=""></a>
                <a href="${webRoot}/wap/newSearch.ac" class="m-search"><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/sousuo2.png" alt=""></a>
                <c:choose>
                    <c:when test="${empty loginUser}">
                        <a href="${webRoot}/wap/login.ac" class="m-my"><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/wode.png" alt=""></a>
                    </c:when>
                    <c:otherwise>
                        <a href="javascript:void(0);" class="m-my" onclick="window.location.href='${webRoot}/wap/module/member/index.ac?time='+ new Date().getTime();"><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/wode.png" alt=""></a>
                    </c:otherwise>
                </c:choose>
                <a href="javascript:void(0);" class="m-share" onclick="showOrHideShare()"><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/fenxiang.png" alt=""></a>
            </div>
        </div>
        <c:choose>
            <c:when test="${isWeixin=='Y'}">
                <div class="share-layer"  style="display: none;" id="share" onclick="showOrHideShare()">
                    <div class="share-box"><img src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/images/share390x186.png" alt=""></div>
                </div>
            </c:when>
            <c:otherwise>
                ...
                <c:otherwise>
                    <c:choose>
                        <c:when test="${productProxy.isNormal == 'Y'}">
                            ...
                            <a href="javascript:void(0);" class="my-cart" onclick="window.location.href='${webRoot}/wap/outlettemplate/default/shoppingcart/drugCart.ac?carttype=store_drug&handler=store_drug&time='+ new Date().getTime()">预定单<span class="cartNum">${drugProxy.allCartNum}</span></a>
                            <a href="javascript:void(0);" class="cart" skuid="${productProxy.isEnableMultiSpec=='Y' ?  '': productProxy.skus[0].skuId}"  num="1" carttype="store_drug" handler="store_drug" onclick="addToCartOrBuyNow(this, false)">加入预定单</a>
                            <a href="javascript:void(0);" class="buy" skuid="${productProxy.isEnableMultiSpec=='Y' ?  '': productProxy.skus[0].skuId}"  num="1" carttype="store_drug" handler="store_drug" onclick="addToCartOrBuyNow(this, true)">立即预定</a>
                        </c:when>
                        <c:otherwise>
                            <a href="${webRoot}/wap/presale/preSaleList.ac?productId=${param.id}" class="zx-btn">售前咨询</a>
                            <a href="javascript:void(0);" class="my-cart" onclick="window.location.href='${webRoot}/wap/outlettemplate/default/shoppingcart/cart.ac?time='+ new Date().getTime()">购物车<span class="cartNum">${normalProxy.allCartNum}</span></a>
                            <a href="javascript:void(0);" class="cart" skuid="${productProxy.isEnableMultiSpec=='Y' ?  '': productProxy.skus[0].skuId}"  num="1" carttype="store" handler="store" onclick="addToCartOrBuyNow(this, false)">加入购物车</a>
                            <a href="javascript:void(0);" class="buy" skuid="${productProxy.isEnableMultiSpec=='Y' ?  '': productProxy.skus[0].skuId}"  num="1" carttype="store" handler="store" onclick="addToCartOrBuyNow(this, true)">立即购买</a>
                        </c:otherwise>
                    </c:choose>
                </c:otherwise>
            </c:choose>
        ...
        <c:choose>
            <c:when test="${empty shopInf.images[0]['']}">
                <c:set var="imgUrl" value="${webUrl}/template/bdw/wap/outlettemplate/default/statics/images/pic460x460.jpg"/>
            </c:when>
            <c:otherwise>
        ...
        <script src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/swiper.min.js"></script>
        <script src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/jquery.infinitescroll.min.js" type="text/javascript"></script>
        <c:if test="${isWeixin=='Y'}">
            <script src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/jweixin-1.2.0.js"></script>
            <script src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/weixinJsConfigInit.js"></script>
            <script src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/productShare.js"></script>
        </c:if>
        <script src="${webRoot}/template/bdw/wap/outlettemplate/default/statics/js/product.js"></script>
        ...
        <script>
            $(document).ready(function () {
                ...
                if(webPath.isSpecialPrice == "true"){
                    //倒计时总秒数量
                    var endTime = new Date(Date.parse(remTime.attr("endTimeStr").replace(/-/g,"/"))).getTime();
