...
<link type="text/css" rel="stylesheet" href="${webRoot}/template/bdw/wap/module/member/cps/statics/css/cpsWapExtension.css">
            ...
            <c:when test="${param.type=='theme'}">
                ...
                <c:choose>
                    <c:when test="${empty frialProxy.explanation}">
                        <c:set var="bdText" value="${fn:substring(sdk:cleanHTML(frialProxy.wapThemeDescStr,''),0 , 120)}"/>
                    </c:when>
                    <c:otherwise>
                        <c:set var="bdText" value="${frialProxy.explanation}"/>
                    </c:otherwise>
                </c:choose>
                <c:set var="bdDesc" value="${frialProxy.themeName}"/>
                <li class="media">
            ...
            <c:otherwise>
                ...
                <li class="media">
                    ...
                    <div class="media-cont-win">
                        ...
                        <c:set var="bdDesc" value="${productProxy.name}"/>
    ...
    <div class="copy-modal-dialog">
        <div class="copy-modal-content">
            ...
            <div class="copy-modal-footer">
                <a class="copy-btn-link" href="javascript:void(0);">关闭</a>
            </div>
        </div>
    </div>
</div>
