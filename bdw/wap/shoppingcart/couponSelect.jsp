...
<head lang="en">
    ...
    <link href="${webRoot}/template/bdw/wap/statics/css/coupons.css" type="text/css" rel="stylesheet" />
</head>
            ...
            success:function(data) {
                if(data.success=="true"){
                    if("drug" == "${cartType}"){
                        ...
                        window.location.href = "${webRoot}/wap/shoppingcart/orderAdd.ac?carttype=${cartType}&handler=${param.handler}&time=" + new Date().getTime();
                    }
                }
            },
