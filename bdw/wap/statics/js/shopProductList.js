$(document).ready(function(){
    ...
    $("#searchInput").bind("keyup", function (e) {
        if(e.keyCode == 13){
            window.location.href=paramData.webRoot+"/wap/shop/shopProductList.ac?shopId="+ paramData.shopId +"&shopCategoryId="+paramData.shopCategoryId+"&q="+paramData.q+"&isInStore="+paramData.isInStore+"&keyword="+$(this).val()+"&order="+paramData.order;
        }
    });
    ...
    $("#isInStore").click(function(){
        ...
        window.location.href=paramData.webRoot+"/wap/shop/shopProductList.ac?shopId="+ paramData.shopId +"&shopCategoryId="+paramData.shopCategoryId+"&q="+paramData.q+"&isInStore="+isInStore+"&keyword="+paramData.keyword+"&order="+paramData.order;
    });
...
function changeSortByOnSaleDate(obj) {
    ...
    if ("lastOnSaleDate,desc" == order) {
        window.location.href =paramData.webRoot+"/wap/shop/shopProductList.ac?shopId="+ paramData.shopId +"&shopCategoryId="+paramData.shopCategoryId+"&q="+paramData.q+  "&isInStore="+ paramData.isInStore +"&keyword="+paramData.keyword+"&order=lastOnSaleDate,asc"+"&page="+paramData.page;
    } else {
        window.location.href =paramData.webRoot+"/wap/shop/shopProductList.ac?shopId="+ paramData.shopId +"&shopCategoryId="+paramData.shopCategoryId+"&q="+paramData.q+  "&isInStore="+ paramData.isInStore +"&keyword="+paramData.keyword+"&order=lastOnSaleDate,desc"+"&page="+paramData.page;
    }
}
