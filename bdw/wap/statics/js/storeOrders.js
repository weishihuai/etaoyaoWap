...
$(function(){
    ...
    slider.find("a").click(function () {
		...
		reLoadOrderList(rel,searchValue);
    });
    ...
    dd_inner.find("li").click(function () {
        ...
        reLoadOrderList($(this).attr("rel"),searchValue);
    });
...
function searchOrder(){
	...
	reLoadOrderList(selectStatus,searchField);
}
 ...
 */
function reLoadOrderList(orderStatus,searchField) {
	if ('' != searchField &&  null != searchField && undefined != searchField) {
        window.location.href = webPath.webRoot + "/wap/module/member/storeOrder.ac?status="+orderStatus+"&searchField="+searchField;
	} else {
        window.location.href = webPath.webRoot + "/wap/module/member/storeOrder.ac?status="+orderStatus;
	}
}