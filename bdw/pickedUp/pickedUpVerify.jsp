...
<c:set value="${bdw:findReceivingList('Y','N','N','',param.receiverName,param.Mobile,_page,20)}" var="notReceiving"/>
<c:set value="${bdw:findReceivingList('Y','Y','N','',param.receiverName,param.Mobile,_page,20)}" var="receiving"/>
<c:set value="${bdw:findReceivingList('Y','Y','Y','',param.receiverName,param.Mobile,_page,20)}" var="pickedUp"/>
<html>
<head>
  ...
  <script type="text/javascript" src="${webRoot}/template/bdw/pickedUp/js/pickedUpVerify.js"></script>
</head>
<body>
  ...
  <div class="t_index">
    ...
    <div class="id_main">
      <div class="verify">
        <div class="item">
          <span>订单编号:</span>
          <input type="text" value="${orderNum}" id="OrderNumVerify" />
        </div>
        <div class="item fore2 cur">
          <span>提货码:</span>
          <div class="error" id="error"></div>
          <input type="text" id="myDelivery" />
        </div>
        <div class="login_btn"><a href="javascript:;">确认提货</a></div>
      </div>
    </div>
