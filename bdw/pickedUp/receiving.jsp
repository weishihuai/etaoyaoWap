...
<head>
    ...
    <script type="text/javascript" src="${webRoot}/template/bdw/pickedUp/js/receiving.js"></script>
</head>
<body>
    ...
    <div class="t_index">
        <div class="id_top">
            <ul>
                ...
                <li class="cur">
                    <a href="javascript:;">已收货订单<em>（<i>${not empty receiving?receiving.totalCount:0}</i>）</em></a>
                </li>
                <li class="last">
        ...
        <div class="id_main">
            ...
            <%--<div class="s_result">为您找到 “<span>${receiving.totalCount}</span>” 条相关的订单</div>--%>
            <c:choose>
                <c:when test="${receiving.totalCount>0}">
                    <ul class="m_cont">
                        <c:forEach items="${receiving.result}" var="productProxy" varStatus="s">
                            <li>
                                <div class="mc_lt">
                                    ...
                                    <%--<div class="mc_th"><a href="javascript:;" class="myIsReceiving">提货</a></div>--%>
                                <div class="mc_rt"><a href="${webRoot}/template/bdw/pickedUp/pickedUpVerify.jsp?orderNum=${productProxy.orderNum}" class="take myIsReceiving">提货</a></div>
                                    <%--确认收货弹出窗口提示 start--%>
                                    <%--确认收货弹出窗口提示 end--%>
